...
直近約３か月間のAI関連のニュースや論文紹介サイトを中心に情報収集を行い、得られた記事を要約した上で単語単位に分割し、出現頻度や共起関係をもとにキーワードマップを作成しました。これをもとに、**「どんな話題が注目され、どの概念同士がつながって語られているか」を俯瞰**します。以下は、話題になったテーマの全体像です。
